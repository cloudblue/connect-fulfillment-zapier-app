...
describe('Connect Fulfillment Zapier App - Create Tier Config Request of type "update" (with Line Items support)', () => {
  let sandbox;
  ...
  it('should return a newly create tier config request', done => {
    ...
    sandbox.stub(Fulfillment.prototype, 'createUpdateTierConfigRequest')
      .withArgs(bundle.inputData.config_id, bundle.inputData.params)
      .returns(responses.creates.fill_tier_params);
    // Call to zapier function to test
    appTester(App.creates.create_update_tier_config_request_lis.operation.perform, bundle)
      .then(results => {
