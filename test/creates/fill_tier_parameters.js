...
describe('Connect Fulfillment Zapier App - Fill Tier Parameters', () => {
  let sandbox;
  ...
  it('should return a request with tier parameter filled', done => {
    ...
    sandbox.stub(Fulfillment.prototype, 'updateTierConfigRequestParameters')
      .withArgs(bundle.inputData.request_id, [{id: 'param_a', value: 'value_a'}], bundle.inputData.notes)
      .returns(responses.creates.fill_fulfillment_params);
    // Call to zapier function to test
    appTester(App.creates.fill_tier_params.operation.perform, bundle)
      .then(results => {
