...
const authentication = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'password',
      required: true,
      helpText: 'Please go to the [Connect documentation portal](https://connect.cloudblue.com/documentation/extensions/zapier/) to get additional help on how to obtain a token.',
    },
    {
      key: 'actual_api_key',
      required: false,
