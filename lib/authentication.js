...
const testAuth = async (z, bundle) => {
  ...
  try {
    ...
    apiKey = `ApiKey ${response.json.id}:${response.json.token}`;
  } catch (e) {
...
const authentication = {
  ...
  fields: [
    ...
    },
    {
      ...
      type: 'password',
      required: true,
      helpText: 'Please go to the [Connect documentation portal](https://connect.cloudblue.com/documentation/extensions/zapier/create-zapier-app-connection/) to get additional help on how to obtain a token.',
    },
    {
      key: 'actual_api_key',
      required: false,
