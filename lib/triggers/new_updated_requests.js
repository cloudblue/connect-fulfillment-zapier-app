...
module.exports = {
  ...
  display: {
    ...
    description: 'Using polling to CloudBlue Connect, the Zap will be executed when a fulfillment request is created or gets updated on the fulfillment queue.',
  },
