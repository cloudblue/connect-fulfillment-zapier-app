...
module.exports = {
  key: 'new_recurring_assets',
  noun: 'Recurring Asset',

  display: {
    label: 'New Recurring Asset',
    description: 'Triggers when a new recurring asset appears on the subscriptions queue using polling to CloudBlue Connect.',
  },
