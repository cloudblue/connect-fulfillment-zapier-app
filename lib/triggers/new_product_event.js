...
const subscribe = async (z, bundle) => {
  const data = {
    ...
    object_class: bundle.inputData.object_class,
  ...
  operation: {
    inputFields: [
      ...
      },
      {
        ...
        type: 'string',
        label: 'Object class',
        helpText: 'Choose the type of request for which you want to listen to events.',
        required: true,
        choices: {
          fulfillment_request: 'Asset Request',
          tier_config_request: 'Tier Configuration Request',
