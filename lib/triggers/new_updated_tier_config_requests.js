...
module.exports = {
  ...
  display: {
    ...
    description: 'Using polling to CloudBlue Connect, the Zap will be executed when a Tier Config request request is created or gets updated on the fulfillment queue.',
  },
