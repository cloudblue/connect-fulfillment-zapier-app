...
const OrderingParameters = require('./hidden/orderingParameters');
const OrderingFulfillmentParameters = require('./hidden/orderingFulfillmentParameters');
const TCRParameters = require('./hidden/tcrParameters');
const FillTCRParameters = require('./hidden/fillTCRParameters');
...
module.exports = {
  ...
  [OrderingParameters.key]: OrderingParameters,
  [OrderingFulfillmentParameters.key]: OrderingFulfillmentParameters,
  [TCRParameters.key]: TCRParameters,
  [FillTCRParameters.key]: FillTCRParameters,
};
