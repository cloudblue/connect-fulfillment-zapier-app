...
const NewCases = require('./caseRequest/new_case');
const NewCaseComments = require('./caseRequest/new_case_conversation');
...
module.exports = {
  ...
  [NewCases.key]: NewCases,
  [NewCaseComments.key]: NewCaseComments,
