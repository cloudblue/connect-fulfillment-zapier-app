...
module.exports = {
  ...
  display: {
    ...
    description: 'Using polling to CloudBlue Connect, the Zap will be executed when new messages appears '
      + 'either to concrete request, either to concrete listing request.',
  },
  operation: {
    inputFields: [
      {
