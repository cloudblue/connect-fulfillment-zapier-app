...
const { getProductIdByRequestId, getProductParameters } = require('../../connect/api/misc');
...
async function generateParametersFieldsForCreate(z, bundle) {
  ...
  return generateParametersFields(client, productId, bundle.inputData.ordering_parameter_ids);
}
