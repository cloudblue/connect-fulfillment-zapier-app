...
module.exports = [
  ...
  { key: 'asset__tiers__tier2__contact_info__address_line2', label: 'T2 Address Line 1' },
  ...
  { key: 'asset__params[]id', label: 'Param ID' },
  { key: 'asset__params[]name', label: 'Param Name' },
  { key: 'asset__params[]title', label: 'Param Title' },
  { key: 'asset__params[]description', label: 'Param Description' },
  { key: 'asset__params[]type', label: 'Param Type' },
  { key: 'asset__params[]value', label: 'Param Value' },
  { key: 'asset__params[]value_choices', label: 'Param Value Choices' },
  { key: 'asset__params[]value_error', label: 'Param Value Error' },
];
