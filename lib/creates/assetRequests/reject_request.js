...
module.exports = {
  ...
  display: {
    ...
    description: 'Distributors and Vendors can use this action to reject a concrete request.',
  },
  operation: {
    inputFields: [
      {
      ...
      },
      {
        ...
        label: 'Reason',
        required: true,
        helpText: 'Provide a reason why the request has been failed, please note that Distributors and their customers can see it and maybe propagated to commerce system.',
      },
    ],
