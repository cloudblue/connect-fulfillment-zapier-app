...
module.exports = {
  ...
  display: {
    ...
    description: 'Vendors and Distributors can use this actions to add messages '
      + 'to conversations on multiple objects like asset requests, this messages '
      + 'can be seen by vendors and distributors and can provide valuable information like '
    ...
    inputFields: [
      ...
      },
      {
        ...
        helpText: 'Provide the message to be added to the conversation, please note that all actors '
          + 'with access to the object may see it, including vendors, distributors and '
