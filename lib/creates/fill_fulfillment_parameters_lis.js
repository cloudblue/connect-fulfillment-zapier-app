...
module.exports = {
  ...
  display: {
    label: 'Fill fulfillment parameters for Request (with line items support)',
    description: 'Fill fulfillment parameters for Request Asset (with line items support).',
  },
  operation: {
    inputFields: [
